...
function onEachFeature(feature, layer) {
    var popup = "<h5>" + feature.properties.Organization + "</h5>" + "<h6>" + feature.properties.Category + '</h6>' + "<h5 style='margin-bottom:3px;'>" + feature.properties.Address + "</h5>"  + feature.properties.Phone + "<br><a href='http://" + feature.properties.Web + "' target='_blank'>" + feature.properties.Web + "</a>";
